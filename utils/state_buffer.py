...
if  __name__ == '__main__':
    ...
    parser.add_argument("--frame_width", type=int, default=50, help="Frame width after resize.")
    parser.add_argument("--frame_height", type=int, default=50, help="Frame height after resize.")
